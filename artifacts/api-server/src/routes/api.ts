...
// Legacy GET + PUT /business/:id/customization endpoints removed in
// Stage 6 follow-ups. The /settings/ai surface (PromptEditor + the
// /api/business/prompt* endpoints) has been the only customer-facing
// path for AI customization since the Monday decommission. ~180 lines
// of duplicate save/sync logic dropped.
